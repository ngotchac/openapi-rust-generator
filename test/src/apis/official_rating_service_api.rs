...
pub struct OfficialRatingServiceApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl OfficialRatingServiceApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> OfficialRatingServiceApiClient {
        OfficialRatingServiceApiClient {
            configuration,
        }
    }
}
