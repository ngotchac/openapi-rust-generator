...
pub struct CollectionServiceApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl CollectionServiceApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> CollectionServiceApiClient {
        CollectionServiceApiClient {
            configuration,
        }
    }
}
...
impl CollectionServiceApiClient {
    pub async fn delete_collections_by_id_items(&self, ids: &str, id: &str) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Collections/{Id}/Items", configuration.base_path, Id=crate::apis::urlencode(id));
    ...
    pub async fn post_collections(&self, is_locked: Option<bool>, name: Option<&str>, parent_id: Option<&str>, ids: Option<&str>) -> Result<Box<crate::models::CollectionsCollectionCreationResult>, Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
    ...
    pub async fn post_collections_by_id_items(&self, ids: &str, id: &str) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
