...
pub struct ReportsServiceApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl ReportsServiceApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> ReportsServiceApiClient {
        ReportsServiceApiClient {
            configuration,
        }
    }
}
...
impl ReportsServiceApiClient {
    pub async fn get_reports_activities(&self, report_view: &str, display_type: &str, has_query_limit: Option<bool>, group_by: Option<&str>, report_columns: Option<&str>, start_index: Option<i32>, limit: Option<i32>, include_item_types: Option<&str>) -> Result<Box<crate::models::EmbyReportsApiModelReportResult>, Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Reports/Activities", configuration.base_path);
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());

        req_builder = req_builder.query(&[("ReportView", &report_view.to_string())]);
        req_builder = req_builder.query(&[("DisplayType", &display_type.to_string())]);
        if let Some(ref s) = has_query_limit {
            req_builder = req_builder.query(&[("HasQueryLimit", &s.to_string())]);
        }
        if let Some(ref s) = group_by {
            req_builder = req_builder.query(&[("GroupBy", &s.to_string())]);
        }
        if let Some(ref s) = report_columns {
            req_builder = req_builder.query(&[("ReportColumns", &s.to_string())]);
        }
    ...
    pub async fn get_reports_headers(&self, report_view: &str, display_type: &str, include_item_types: Option<&str>, report_columns: Option<&str>) -> Result<Vec<Box<crate::models::EmbyReportsApiModelReportHeader>>, Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Reports/Headers", configuration.base_path);
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_reports_items(&self, report_view: &str, display_type: &str, max_official_rating: Option<&str>, has_theme_song: Option<bool>, has_theme_video: Option<bool>, has_subtitles: Option<bool>, has_special_feature: Option<bool>, has_trailer: Option<bool>, adjacent_to: Option<&str>, min_index_number: Option<i32>, min_players: Option<i32>, max_players: Option<i32>, parent_index_number: Option<i32>, has_parental_rating: Option<bool>, is_hd: Option<bool>, location_types: Option<&str>, exclude_location_types: Option<&str>, is_missing: Option<bool>, is_unaired: Option<bool>, min_community_rating: Option<f64>, min_critic_rating: Option<f64>, aired_during_season: Option<i32>, min_premiere_date: Option<&str>, min_date_last_saved: Option<&str>, min_date_last_saved_for_user: Option<&str>, max_premiere_date: Option<&str>, has_overview: Option<bool>, has_imdb_id: Option<bool>, has_tmdb_id: Option<bool>, has_tvdb_id: Option<bool>, exclude_item_ids: Option<&str>, start_index: Option<i32>, limit: Option<i32>, recursive: Option<bool>, sort_order: Option<&str>, parent_id: Option<&str>, fields: Option<&str>, exclude_item_types: Option<&str>, include_item_types: Option<&str>, filters: Option<&str>, is_favorite: Option<bool>, is_movie: Option<bool>, is_series: Option<bool>, is_news: Option<bool>, is_kids: Option<bool>, is_sports: Option<bool>, media_types: Option<&str>, image_types: Option<&str>, sort_by: Option<&str>, is_played: Option<bool>, genres: Option<&str>, official_ratings: Option<&str>, tags: Option<&str>, years: Option<&str>, enable_images: Option<bool>, enable_user_data: Option<bool>, image_type_limit: Option<i32>, enable_image_types: Option<&str>, person: Option<&str>, person_ids: Option<&str>, person_types: Option<&str>, studios: Option<&str>, studio_ids: Option<&str>, artists: Option<&str>, artist_ids: Option<&str>, albums: Option<&str>, ids: Option<&str>, video_types: Option<&str>, containers: Option<&str>, user_id: Option<&str>, min_official_rating: Option<&str>, is_locked: Option<bool>, is_place_holder: Option<bool>, has_official_rating: Option<bool>, collapse_box_set_items: Option<bool>, is3_d: Option<bool>, series_status: Option<&str>, name_starts_with_or_greater: Option<&str>, name_starts_with: Option<&str>, name_less_than: Option<&str>, has_query_limit: Option<bool>, group_by: Option<&str>, report_columns: Option<&str>) -> Result<Box<crate::models::EmbyReportsApiModelReportResult>, Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Reports/Items", configuration.base_path);
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
        ...
        if let Some(ref s) = collapse_box_set_items {
            req_builder = req_builder.query(&[("CollapseBoxSetItems", &s.to_string())]);
        }
    ...
    pub async fn get_reports_items_download(&self, report_view: &str, display_type: &str, max_official_rating: Option<&str>, has_theme_song: Option<bool>, has_theme_video: Option<bool>, has_subtitles: Option<bool>, has_special_feature: Option<bool>, has_trailer: Option<bool>, adjacent_to: Option<&str>, min_index_number: Option<i32>, min_players: Option<i32>, max_players: Option<i32>, parent_index_number: Option<i32>, has_parental_rating: Option<bool>, is_hd: Option<bool>, location_types: Option<&str>, exclude_location_types: Option<&str>, is_missing: Option<bool>, is_unaired: Option<bool>, min_community_rating: Option<f64>, min_critic_rating: Option<f64>, aired_during_season: Option<i32>, min_premiere_date: Option<&str>, min_date_last_saved: Option<&str>, min_date_last_saved_for_user: Option<&str>, max_premiere_date: Option<&str>, has_overview: Option<bool>, has_imdb_id: Option<bool>, has_tmdb_id: Option<bool>, has_tvdb_id: Option<bool>, exclude_item_ids: Option<&str>, start_index: Option<i32>, limit: Option<i32>, recursive: Option<bool>, sort_order: Option<&str>, parent_id: Option<&str>, fields: Option<&str>, exclude_item_types: Option<&str>, include_item_types: Option<&str>, filters: Option<&str>, is_favorite: Option<bool>, is_movie: Option<bool>, is_series: Option<bool>, is_news: Option<bool>, is_kids: Option<bool>, is_sports: Option<bool>, media_types: Option<&str>, image_types: Option<&str>, sort_by: Option<&str>, is_played: Option<bool>, genres: Option<&str>, official_ratings: Option<&str>, tags: Option<&str>, years: Option<&str>, enable_images: Option<bool>, enable_user_data: Option<bool>, image_type_limit: Option<i32>, enable_image_types: Option<&str>, person: Option<&str>, person_ids: Option<&str>, person_types: Option<&str>, studios: Option<&str>, studio_ids: Option<&str>, artists: Option<&str>, artist_ids: Option<&str>, albums: Option<&str>, ids: Option<&str>, video_types: Option<&str>, containers: Option<&str>, user_id: Option<&str>, min_official_rating: Option<&str>, is_locked: Option<bool>, is_place_holder: Option<bool>, has_official_rating: Option<bool>, collapse_box_set_items: Option<bool>, is3_d: Option<bool>, series_status: Option<&str>, name_starts_with_or_greater: Option<&str>, name_starts_with: Option<&str>, name_less_than: Option<&str>, has_query_limit: Option<bool>, group_by: Option<&str>, report_columns: Option<&str>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Reports/Items/Download", configuration.base_path);
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
