...
pub struct TrailersServiceApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl TrailersServiceApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> TrailersServiceApiClient {
        TrailersServiceApiClient {
            configuration,
        }
    }
}
