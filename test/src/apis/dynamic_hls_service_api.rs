...
pub struct DynamicHlsServiceApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl DynamicHlsServiceApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> DynamicHlsServiceApiClient {
        DynamicHlsServiceApiClient {
            configuration,
        }
    }
}
...
impl DynamicHlsServiceApiClient {
    ...
    pub async fn get_audio_by_id_main_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Audio/{Id}/main.m3u8", configuration.base_path, Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_audio_by_id_master_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Audio/{Id}/master.m3u8", configuration.base_path, Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_videos_by_id_hls1_by_playlistid_by_segmentid_by_segmentcontainer(&self, playlist_id: &str, segment_id: &str, segment_container: &str, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Videos/{Id}/hls1/{PlaylistId}/{SegmentId}.{SegmentContainer}", configuration.base_path, PlaylistId=crate::apis::urlencode(playlist_id), SegmentId=crate::apis::urlencode(segment_id), SegmentContainer=crate::apis::urlencode(segment_container), Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_videos_by_id_main_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Videos/{Id}/main.m3u8", configuration.base_path, Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_videos_by_id_master_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Videos/{Id}/master.m3u8", configuration.base_path, Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    pub async fn get_videos_by_id_subtitles_m3u8(&self, id: &str, subtitle_segment_length: i32, manifest_subtitles: &str) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;

        let uri_str = format!("{}/Videos/{Id}/subtitles.m3u8", configuration.base_path, Id=crate::apis::urlencode(id));
        let mut req_builder = req_client.request(reqwest::Method::GET, uri_str.as_str());

        req_builder = req_builder.query(&[("SubtitleSegmentLength", &subtitle_segment_length.to_string())]);
        req_builder = req_builder.query(&[("ManifestSubtitles", &manifest_subtitles.to_string())]);
        if let Some(ref user_agent) = configuration.user_agent {
            req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
        }
    ...
    pub async fn head_audio_by_id_hls1_by_playlistid_by_segmentid_by_segmentcontainer(&self, playlist_id: &str, segment_id: &str, segment_container: &str, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
    ...
    pub async fn head_audio_by_id_master_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
    ...
    pub async fn head_videos_by_id_hls1_by_playlistid_by_segmentid_by_segmentcontainer(&self, playlist_id: &str, segment_id: &str, segment_container: &str, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
    ...
    pub async fn head_videos_by_id_master_m3u8(&self, id: &str, container: &str, device_profile_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, audio_sample_rate: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, _static: Option<bool>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<&str>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, video_codec: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>) -> Result<(), Error> {
        let configuration: &configuration::Configuration = self.configuration.borrow();
        let req_client = &configuration.client;
